...
class Metadata_Constants{
	public static $ID_METADATA_STRING = '_id';
	public static $PARENT_ID_METADATA_STRING = '_id_prnt';
	public static $PARENT_CLASS_STRING = 'parent';
	public static $BASE_CLASS_STRING = 'base_class';
	public static $TABLE_NAME_STRING = 'table_name';
